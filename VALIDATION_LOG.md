...
| fix3 final — single all-region + flagship regeneration (2026-07-18) | **25/27** varying in the 147-site Durham flagship (truthful constants: CSO and unsupported litter complaints); **449/449** regional outputs, 9,903 sites, 13 honest zero-candidate regions | n/a | **21/27** primary (= hard-stop floor; 0/27 at ≥70 diagnostic; zero run failures) | **94.1%** (exact 94.112%; min 75.2, max 100.0, 9/10 >90%): 0.088 point below the 94.2 tolerance floor, recorded without tuning frozen scoring math or performing a second regeneration | vs `paper-2026`: Spearman ρ 0.895420; 7/10 paper top-10 remain top-10, 9/10 top-25; largest paper top-10 shift 9→42. vs previous live flagship at `7589221`: ρ 0.989807; 8/10 prior top-10 remain top-10, 10/10 top-25; largest prior top-10 shift 8→4 |
